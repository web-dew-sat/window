...
const changeModalState = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width', 'input');
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#height', 'input');
...
const forms = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]', 'input');
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > .row > div', 'after_click');
